...
const Footer = () => {
  return (
    <footer className="border-t border-border bg-background relative overflow-hidden">
      ...
      <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-80 h-40 rounded-full bg-primary/5 blur-3xl" />
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        >
            ...
            <div className="space-y-2">
              {[
                ...
                <Link
                  key={link.to}
                  to={link.to}
                  className="group block text-sm text-muted-foreground hover:text-primary transition-colors font-body"
                >
          ...
          <motion.div variants={fadeUp} custom={2}>
            ...
            <div className="space-y-3">
              <a href="tel:03269946142" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors font-body group">
                <div className="w-8 h-8 rounded-lg glass flex items-center justify-center group-hover:shadow-fire transition-shadow">
          ...
          <motion.div variants={fadeUp} custom={3}>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2 text-sm text-muted-foreground font-body group">
